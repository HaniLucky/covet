...
public class SendEmailUtil {
	...
	public static String myEmailAccount = "Hanilucky@163.com";
	public static String myEmailPassword = "hujun5201314";
	...
	// 收件人邮箱（替换为自己知道的有效邮箱）
	public static String receiveMailAccount = "228321644@qq.com";
	...
	public static void sendEmails(String isValate, String to, String subject, String context) throws Exception {
		...
		props.setProperty("mail.smtp.host", myEmailSMTPHost); // 发件人的邮箱的 SMTP
																// 服务器地址
		props.setProperty("mail.smtp.auth", isValate); // 需要请求认证
		...
		// 3. 创建一封邮件
		MimeMessage message = createMimeMessage(session, myEmailAccount, receiveMailAccount,subject,context);
